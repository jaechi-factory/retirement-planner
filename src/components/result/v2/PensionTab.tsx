      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--tds-gray-700)' }}>
            월 {result.monthlyPensionAtRetirementStart.toLocaleString()}만원
          </div>
        ...
        >
          ...
          <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--tds-gray-700)' }}>
            월 {result.totalMonthlyPensionTodayValue.toLocaleString()}만원
          </div>
          <div style={{ fontSize: 11, color: 'var(--tds-gray-400)', marginTop: 2 }}>
            지금 기준
          </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginBottom: 16 }}>
        {[
          ...
          >
            ...
            >
              {enabled ? `월 ${value.toLocaleString()}만원` : '미반영'}
            </span>
          </div>
        ))}
      </div>
                ...
                <div key={`${ev.age}-${ev.pensionType}`} style={{ display: 'flex', gap: 12 }}>
                  ...
                  <div style={{ paddingBottom: isLast ? 0 : 14, flex: 1 }}>
                    ...
                    <div style={{ fontSize: 12, color: 'var(--tds-gray-700)', marginTop: 2 }}>
                      +월 {ev.monthlyTodayValue.toLocaleString()}만원 시작
                    </div>
